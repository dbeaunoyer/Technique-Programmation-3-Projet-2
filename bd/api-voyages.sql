...
--
-- Hôte : localhost
-- Généré le : sam. 29 jan. 2022 à 03:08
...
--
-- Structure de la table `grossistes`
--

CREATE TABLE `grossistes` (
  `id` int NOT NULL,
  `fournisseur` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `transporteur` varchar(100) COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Déchargement des données de la table `grossistes`
--

INSERT INTO `grossistes` (`id`, `fournisseur`, `transporteur`) VALUES
(1, 'HolaSun', 'Pascan Aviation'),
(2, 'Vacances Transat', 'Transat'),
(3, 'Vacances Signature', 'Air Canada'),
(4, 'hola Señor', 'Westjet'),
(5, 'Unik-Tour', 'Air Canada'),
(6, 'Vacances Sunquest', 'Porter Airlines');
...
--
-- Index pour la table `grossistes`
--
ALTER TABLE `grossistes`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT pour la table `grossistes`
--
ALTER TABLE `grossistes`
